...
<head>
    ...
    <style>
        ...
        a {
            ...
            padding: 15px;
            border-radius: 5px;
            background-color: #00796b; /* Dark cyan background for links */
...
<body>
    <div class="container">
        ...
        <a href="updateRawMaterial">Update Raw Material</a>
        <a href="showUnavailableRawItem">Show Unavailable Raw Material</a>
    </div>
